...
def analyze_dataset(folder: str = '../shared_data/training', output_prefix: str = 'dataset_stats'):
    total_files = 6265  # falls bekannt
    batch_size = 100
    idx = 0
    ...
    print(f"\n✅ Statistik gespeichert unter: {json_file}")

    # CSV: Patienten-Aufnahmen
    ...
    print(f"✅ Patienten-Aufnahmen gespeichert unter: {csv_patient_file}")
    ...
    print(f"✅ Referenzsysteme gespeichert unter: {csv_ref_file}")

    # CSV: Sampling Frequenzen
    ...
    print(f"✅ Sampling Frequenzen gespeichert unter: {csv_sf_file}")

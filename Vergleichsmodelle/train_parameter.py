...
# ---- Datei zum automatisierten Trainierne des Modells mit verschiedenen Parametern ----
...
def main():
    ...
    # Definieren der Standardparameter
    default_lr = 1e-4
    ...
    # Definiern der zu testenden Parameter
    optimizers = [
    ...
    # Zum Testen der verschiedenen Window und step sizes 
